...
SESSION_USER_KEY = "am_user"
KEYCLOAK_STATE_SESSION_KEY = "am_keycloak_state"
HOME_PROVISION_TARGET_SESSION_KEY = "am_home_provision_target"
PENDING_PROVISION_SESSION_KEY = "am_pending_provision"
KEYCLOAK_DIAGNOSTIC_SESSION_KEY = "am_keycloak_diagnostic"
...
DISABLED_USER_MESSAGE = _("Cet utilisateur est désactivé dans Animation Messe.")
UNKNOWN_USER_MESSAGE = _(
    "Aucun utilisateur correspondant n'a été trouvé dans Animation Messe. "
...
def _keycloak_http_error_message(stage: str, status_code: int) -> str:
    if status_code == 401 and stage == "token_exchange":
        return _(
            "La connexion Keycloak a échoué pendant l'échange du code. Vérifiez la configuration du client AM côté Keycloak."
        )
