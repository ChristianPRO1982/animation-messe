...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            database_operations=[
                migrations.RunSQL(
                    sql='ALTER TABLE "am"."m_users" RENAME TO "m_preferences"',
                    reverse_sql='ALTER TABLE "am"."m_preferences" RENAME TO "m_users"',
                ),
                migrations.RunSQL(
                    sql='ALTER TABLE "am"."m_preferences" RENAME COLUMN "id" TO "member_id"',
                    reverse_sql='ALTER TABLE "am"."m_preferences" RENAME COLUMN "member_id" TO "id"',
                ),
                migrations.RunSQL(
                    sql=(
